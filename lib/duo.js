...
/**
 * Use an async, sync or generator `transform` function.
 *
...
Duo.prototype.plugin = function (fn) {
  fn(this.plugins);
  return this;
};
...
Duo.prototype.run = unyield(function *() {
  ...
  // call post-resolve hooks
  //yield this.plugins.runPostResolve(file, deps);
  ...
  // call pre-packaging hooks
  //yield this.plugins.runPrePack(deps);
  ...
  // call pre-packaging hooks
  //yield this.plugins.runPostPack(rel);
...
Duo.prototype.dependency = function *(dep, file, entry) {
  ...
  dep = yield this.plugins.runResolve(dep, file, entry);
  ...
  yield this.plugins.runInstall(pkg);
